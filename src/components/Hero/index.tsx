		...
		<HeroSection>
			...
			{lang === "EN" ? (
				<>
					...
					<SelfIntro>
						{`I'm a frontend developer specializing in building exceptional digital experiences. Recently, I become a freelancer and looking for new opportunities, so feel free to say `}
